        ...
        <div className="container mx-auto max-w-md bg-white shadow-lg rounded-md p-8">
          ...
          <div className="text-center mt-8">
            ...
            <Button className="w-full bg-gray-100 border text-black py-2 rounded mt-2 flex items-center justify-center">
              <Image src="/shop-detail/google (1).png" width={24} height={24} alt="Google" className="w-[20px] h-[20px] left-[16px] mr-2" />
              Sign up with Google
            </Button>
            <Button className="w-full bg-gray-100 border text-black py-2 rounded mt-2 flex items-center justify-center">
              <Image src="/shop-detail/apple (1).png" width={24} height={24} alt="Apple" className="w-[24px] h-[24px] left-[16px] mr-2" />
              Sign up with Apple
            </Button>
          </div>
        </div>
